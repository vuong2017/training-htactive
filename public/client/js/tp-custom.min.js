...
jQuery(document).ready(function() {
   ...
   $('.liDark').click(function(){
      ...
      if(mode == 'D'){
         ...
         $(this).data('mode','L');
         $(this).find('span').html('<i class="fa fa-toggle-off lg"></i>');
         $(this).find('b').html('&nbsp;Light');
      } else {
         lightMode();
         createCookie("theme", 'L', 365);
         $(this).data('mode','D');
         $(this).find('span').html('<i class="fa fa-toggle-on lg"></i>');
    ...
    function a() {
        jQuery(".eckosc_tab_container").each(function() {
            ...
            jQuery(".eckosc_tab_item", e).each(function() {
                ...
                jQuery(t).append("<div class='eckosc eckosc_tab_header_item font_alt' data-title='" + e + "'>" + e + "</div>"), jQuery(this).addClass("eckosc_tab_item__inactive")
...
$(function() {
    ...
    $(".magnifying-glass").click(function(a) {
        $(".header-search-box").is(":hidden") ? (a.stopPropagation(), $(".header-search-box").show().focus(), $(".header-search-box").animate({
            width: 100 == $(".header-search-box").width() ? "0px" : "435px",
            opacity: 1
        }, "slow", function() {
            0 == $(".header-search-box").width() && $(".header-search-box").hide()
        })) : $el.animate({
            width: 435 == $el.width() ? "435px" : "0px",
            opacity: .3
        }, "slow", function() {
            0 == $el.width() &&
                $el.hide()
