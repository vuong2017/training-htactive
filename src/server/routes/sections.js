...
export default (router) => {
  ...
  router.put('/updateItemSections', updateItemSections); //http://localhost:2048/api/updateItemSections
  router.delete('/deleteItems', deleteItems); //http://localhost:2048/api/deleteItems
};
